...
import { Edit, Trash2, Printer, Plus, Minus, ChevronLeft, ChevronRight, Utensils, Pencil } from 'lucide-react';
...
const OrderLine = () => {
  ...
  return (
    <div className="w-full p-6">
      ...
      {/* Horizontal Orders Row with styling that matches the screenshot */}
        ...
        {filteredOrders.length > 0 ? (
          filteredOrders.map((order) => (
            <div 
              ...
              className={cn(
                "p-4 rounded-lg cursor-pointer border min-w-[220px]", 
            ...
            >
              ...
              <div className="mb-3">
                <p className="text-xs text-gray-500">{order.status.toLowerCase().replace(/\b\w/g, l => l.toUpperCase())}</p>
              ...
              <div className="flex gap-3">
                <Button 
                  ...
                  className={cn(
                    ...
                    activeOrderDetails.paymentMethod === PaymentMethod.Cash && "border-teal-500 bg-teal-50"
                  )}
                >
                  <span className="flex items-center gap-2">
                    <span className={cn(
                      "w-4 h-4 rounded-full border flex items-center justify-center",
                      activeOrderDetails.paymentMethod === PaymentMethod.Cash && "border-teal-500"
                    )}>
                ...
                <Button 
                  ...
                  className={cn(
                    "flex-1 justify-center", 
                    activeOrderDetails.paymentMethod === PaymentMethod.Card && "border-teal-500 bg-teal-50"
                  )}
                >
                  <span className="flex items-center gap-2">
                    <span className={cn(
                      "w-4 h-4 rounded-full border flex items-center justify-center",
                      activeOrderDetails.paymentMethod === PaymentMethod.Card && "border-teal-500"
                    )}>
